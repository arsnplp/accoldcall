      ...
      <Header
        ...
        rightAction={
          <div className="relative">
            <button onClick={() => setShowActions(!showActions)} className="p-2 -mr-2">
              <Plus className={`h-5 w-5 text-brand-500 transition-transform ${showActions ? 'rotate-45' : ''}`} />
            </button>
            {showActions && (
              <div className="absolute right-0 top-10 bg-white rounded-xl shadow-lg border border-gray-200 py-1 z-50 w-48">
                <button
                  onClick={() => { setShowActions(false); setShowModal(true); }}
